...
import {StyledTableCell, StyledTableRow, StyledTableContainerWrapper, StyledCartProduct, StyledProductInfo, StyledProductImg, StyledQty, StyledCloseIcon} from '../ShoppingCart/styles.js';
          ...
          <TableBody>
            {rows.map((row) => (
              <StyledTableRow key={row.name}>
                ...
                <StyledTableCell align="center"><StyledCartIcon/></StyledTableCell>
